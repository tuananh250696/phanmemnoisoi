...
conn = sqlite3.connect("H:\python IDE\code examp\Store-Management-Software\Database\store.db")
c = conn.cursor()
...
class Application:
    def __init__(self, master, *args, **kwargs):
        ...
        self.date_l = Label(self.right, text="Today's Date: " + str(date), font=('arial 16 bold'), bg='lightblue',
                            fg='white')
    ...
    def add_to_cart(self, *args, **kwargs):
        ...
        if self.quantity_value > int(self.get_stock):
            ...
            for self.p in products_list:
                ...
                self.tempprice = Label(self.right, text=str(product_price[self.counter]), font=('arial 18 bold'),
                                       bg='lightblue', fg='white')
